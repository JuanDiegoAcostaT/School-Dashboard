...
<body>
    ...
    <h2 class="h2__register">Super admin add news site</h2>
    

	<div class="form__mail_sender--container">
        <form class="form__mail_sender" method="post" action="add_news.php">
            ...
            <label>Content:</label>
            <textarea id="message" name="content" rows="8" cols="40"></textarea> <br>
                
            <br>
            <button class="btn__register"  type="submit" class="btn" name="addNews_btn">Add now</button>
